...
$CFG->dbtype    = 'mysqli';      // 'mysqli', 'mariadb', 'mysqli', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'db5000713538.hosting-data.io';  // eg 'dbmy-rdbng344-eu-rw-geo.mysql.webhosting-database.com' or 'db.isp.com' or IP
$CFG->dbname    = 'dbs654924';     // database name, eg moodle
$CFG->dbuser    = 'dbu78288';   // your database username
$CFG->dbpass    = 'Akka2004!';   // your database password
$CFG->prefix    = 'orxi_';       // prefix to use for all table names
$CFG->dboptions = array(
    ...
    'dbsocket'  => false,       // should connection via UNIX socket be used?
                                ...
                                //  here set dbhost to 'dbmy-rdbng344-eu-rw-geo.mysql.webhosting-database.com',
                                //  (please note mysql is always using socket
                                //  if dbhost is 'dbmy-rdbng344-eu-rw-geo.mysql.webhosting-database.com' - if you need
    ...
    'dbcollation' => 'utf8_unicode_ci', // MySQL has partial and full UTF-8
                                ...
                                // 'utf8_unicode_ci', otherwise this option utf8mb4_unicode_ci
                                // can be removed for MySQL (by default it will
                                // use 'utf8_unicode_ci'. This option should
...
$CFG->dataroot  = '/homepages/13/d681483704/htdocs/clickandbuilds/Moodle/.htmfxks6z8qupt.data';
...
//           'dbtype' => 'mysqli',
//           'dblibrary' => 'native',
//           'dbhost' => 'dbmy-rdbng344-eu-rw-geo.mysql.webhosting-database.com',
//           'dbname' => 'moodletest',
//           'dbuser' => 'dbs395701',
//           'dbpass' => 'dbs395701',
//           'behat_prefix' => 'orxi_',
